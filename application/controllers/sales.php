...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	//display invoice 
		...
		$this->data["custom_js"] ='			
		   <script>item_list = ' . json_encode($this->inventory_model->get_item_list()) . '
...
//				 salesrow = new array();
				...
				function addRow() {
			    	...
			    	salesorder_line = new Object();
			    	salesorder_line.item_id = 0,
			    	salesorder_line.quantity = 0


			    	var value = \'<tr><td><select class="item_select"><option>Please Choose:</option>\';
              ...
              $("#sales_table tr:last").before(value);
                ...
                $(\'.item_select\').on("change", function(event){
						...
						salesorder_line.item_id = $(event.target).val();
				  ...
				  $(\'.quantity\').on("keyup", function(event){
				       ...
				       salesorder_line.quantity = $(event.target).val();
  ...
  //              salesrow.addRow();
         ...
         //customer list
         $data['customers'] = $this->contacts_model->contact_list('cn');
         //  print_r( $data['customers'] = $this->contacts_model->contact_list('cn'));
		
		$this->_data_render('app/sales/display_invoice', $data);
        }
